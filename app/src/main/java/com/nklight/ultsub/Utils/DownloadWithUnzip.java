 ...
 */
public class DownloadWithUnzip extends IntentService {
    ...
    public void sendProgress(int progress, ResultReceiver receiver) {
        ...
        progressBundle.putInt(DownloadWithUnzip.DOWNLOAD_PROGRESS, progress);
    ...
    public void downloadStarted(ResultReceiver resultReceiver) {
        ...
        Bundle progressBundle = new Bundle();
        progressBundle.putBoolean(DownloadWithUnzip.DOWNLOAD_STARTED, true);
    ...
    public void downloadCompleted(ResultReceiver resultReceiver) {
        ...
        Bundle progressBundle = new Bundle();
        progressBundle.putBoolean(DownloadWithUnzip.DOWNLOAD_COMPLETED, true);
        resultReceiver.send(STATUS_OK, progressBundle);
    }
    ...
    public void downloadFailed(ResultReceiver resultReceiver) {
        ...
        Bundle progressBundle = new Bundle();
        progressBundle.putBoolean(DownloadWithUnzip.DOWNLOAD_FAILED, true);
    ...
    public static class FileDownloader extends ResultReceiver {
        ...
        public void download(Context context) {
            ...
            if (isOnline(context)) {
                ...
                Intent intent = new Intent(context, DownloadWithUnzip.class);
                intent.putExtra(DownloadWithUnzip.DOWNLOADER_RECEIVER, this);
                intent.putExtra(DownloadWithUnzip.DOWNLOAD_DETAILS, downloadDetails);
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == DownloadWithUnzip.STATUS_OK) {

                if (resultData.containsKey(DownloadWithUnzip.DOWNLOAD_STARTED)
                        && resultData.getBoolean(DownloadWithUnzip.DOWNLOAD_STARTED)) {

                    onDownloadStatusListener.onDownloadStarted();

                } else if (resultData.containsKey(DownloadWithUnzip.DOWNLOAD_COMPLETED)
                        && resultData.getBoolean(DownloadWithUnzip.DOWNLOAD_COMPLETED)) {

                    onDownloadStatusListener.onDownloadCompleted();

                } else if (resultData.containsKey(DownloadWithUnzip.DOWNLOAD_PROGRESS)) {

                    int progress = resultData.getInt(DownloadWithUnzip.DOWNLOAD_PROGRESS);
                    onDownloadStatusListener.onDownloadProgress(progress);

                }

            } else if (resultCode == DownloadWithUnzip.STATUS_FAILED) {
